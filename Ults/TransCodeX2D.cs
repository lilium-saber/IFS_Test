...
public static class TransCodeX2D
{
    ...
    public static List<(decimal a, decimal b, decimal c, decimal d, decimal e, decimal f, decimal p)>
        ...
        [(0.06m, 0, 0, 0.52m, 0, 0, 10),
        (0.06m, 0, 0, -0.52m, 0, 1, 10),
...
public static class TransCodeX3D
{
    ...
    public static List<X3dIfs> Tree3 { get; } =
        [new(0.05m, 0, 0, 0, 0.6m, 0, 0, 0, 0.05m, 0, 0, 1, 10),
        new(0.05m, 0, 0, 0, -0.5m, 0, 0, 0, 0.05m, 0, 0, 1, 10),
        new(0.6m, 0, 0, 0, 0.5m, 0, 0, 0, 0.5m, 0, 0, 0.7m, 30),
        new(0.5m, 0, 0, 0, 0.5m, 0, 0, 0, 0.5m, 0, 1, 0.7m, 50)];

    public static List<X3dIfs> Fern0 { get; } =
        [new(0, 0, 0, 0, 0, 0.16m, 0, 0, 0, 0, 0, 0, 1),
        new(0.85m, 0.04m, 0, -0.04m, 0.85m, 0, 0, 0, 0.85m, 0, 1.6m, 0, 85),
        new(0.2m, -0.26m, 0, 0.23m, 0.22m, 0, 0, 0, 0.2m, 0, 1.6m, 0, 7),
        new(-0.15m, 0.28m, 0, 0.26m, 0.24m, 0, 0, 0, -0.15m, 0, 0.44m, 0, 7),];
